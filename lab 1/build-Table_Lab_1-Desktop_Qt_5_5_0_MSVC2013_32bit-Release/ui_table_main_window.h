...
public:
    ...
    void setupUi(QMainWindow *Table_Main_Window)
    {
        ...
        tableView->setGeometry(QRect(30, 20, 521, 321));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(30, 360, 91, 41));
        pushButton_2 = new QPushButton(centralWidget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(460, 360, 91, 41));
    ...
    void retranslateUi(QMainWindow *Table_Main_Window)
    {
        ...
        pushButton->setText(QApplication::translate("Table_Main_Window", "Add", 0));
        pushButton_2->setText(QApplication::translate("Table_Main_Window", "Delete", 0));
